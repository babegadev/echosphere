...
packet_size = 400
total_offset = 0
device_id = "7C390D0A-9F4F-9DB8-89E5-B8CA822CEE67" #Please enter the id of your device (that is, the device id used to connect to your BT device here)
deepgram_api_id = os.getenv("DEEPGRAM_API_KEY") #enter your deepgram id here
